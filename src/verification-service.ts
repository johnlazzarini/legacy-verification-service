...
/**
 * Accepts v2 create acknowledgement (202 + PENDING) and persists in-flight state.
 * Terminal PASS/FAIL decisions are deferred to webhook completion (future increment).
 */
